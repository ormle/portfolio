...
carousels.forEach(carousel => {
  ...
  const dotsNavs = carousel.querySelector('.carousel__nav');
...
var prevScrollpos = window.scrollY; //Hold previous scroll position
window.onscroll = function() {
  var currentScrollPos = window.scrollY;// Get current scroll position
